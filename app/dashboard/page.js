...
if (appointmentError) {
  ...
  const pending = normalizedAppointments.filter(
    (appointment) =>
  ...
  const expired = normalizedAppointments.filter(
    (appointment) =>
...
return ( <main className="min-h-screen bg-slate-100"> <div className="bg-blue-600 text-white p-5 text-2xl font-bold">
SmartClinic AI </div>
